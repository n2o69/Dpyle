...
# Internal filename: 'Generator.py'
...
def discord_tokens(amount):
    ...
    for x in range(amount):
        ...
        while base64_string.find('==')!= (-1):
            sample_string = str(random.randint(0, 999999999999999999))
            sample_string_bytes = sample_string.encode('ascii')
            base64_bytes = base64.b64encode(sample_string_bytes)
            base64_string = base64_bytes.decode('ascii')
        base64_string = base64_string + '.' + random.choice(string.ascii_letters).upper() + ''.join((random.choice(string.ascii_letters + string.digits) for _ in 
        ...
        token = range(5) + '.' + ''.join((random.choice(string.ascii_letters + string.digits) for _ in range(27)))
        count += 1
        f.write(f'{token}\n')
...
while True:
    ...
    print('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n')
    @print
    gray(f'{gray}[{green}1{gray}]{white} Discord Gifts\n{gray}[{green}2{gray}]{white} Discord Tokens\n ')
    print(f'{green}Select an option >> {white}', end='')
    choice = input()
    if choice == '283929292':
